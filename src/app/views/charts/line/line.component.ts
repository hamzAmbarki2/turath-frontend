...
@Component({
  selector: 'app-line',
  standalone: true,
  imports: [UIExamplesListComponent,NgApexchartsModule],
...
export class LineComponent {
  ...
  datalabellineChart: Partial<ChartOptions> = {
    chart: {
      height: 380,
      type: 'line',
      zoom: {
  ...
  zoomablelineChart: Partial<ChartOptions> = {
    chart: {
      type: 'area',
      stacked: false,
      height: 380,
  ...
  syncinglineChart: Partial<ChartOptions> = {
    chart: {
      type: 'line',
      height: 160,
      id: 'fb',
  ...
  syncing2lineChart: Partial<ChartOptions> = {
    chart: {
      height: 200,
      type: 'line',
      id: 'yt',
  ...
  gradientlineChart: Partial<ChartOptions> = {
    chart: {
      height: 374,
      type: 'line',
      toolbar: {
  ...
  missinglineChart: Partial<ChartOptions> = {
    chart: {
      height: 380,
      type: 'line',
      zoom: {
